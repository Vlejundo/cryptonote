...
const uint64_t EXPECTED_NUMBER_OF_BLOCKS_PER_DAY             = 24 * 60 * 60*120 / DIFFICULTY_TARGET;
...
const char     CRYPTONOTE_NAME[]                             = "Sifycoin";
...
const std::initializer_list<const char*> SEED_NODES = {
  "2003:f8:3bc7:ed00:cafa:bfd6:fecb:8b51:17236",
